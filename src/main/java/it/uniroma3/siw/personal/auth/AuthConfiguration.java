package it.uniroma3.siw.personal.auth;
...
import static it.uniroma3.siw.personal.model.Credentials.ADMIN_ROLE;
...
public class AuthConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeRequests()
                .antMatchers(HttpMethod.GET, "/", "/index", "/login", "/register","/doublog", "/css/**", "/images/**").permitAll()
                ...
                .and().formLogin().loginPage("/doublog")
                .defaultSuccessUrl("/default")
                .and().oauth2Login().loginPage("/doublog")
